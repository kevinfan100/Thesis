...
\newcommand{\titleZH}{六極電磁致動器之精簡控制框架設計與實現}
\newcommand{\titleEN}{Design and Implementation of a Simplified Control Framework for Hexapole Electromagnetic Actuators}
